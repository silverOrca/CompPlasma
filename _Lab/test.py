...
if __name__ == "__main__":
    ...
    #ncells = [20, 40, 60, 80, 100, 120, 140, 160, 180, 200, 220, 240, 260, 270, 280, 300]
    #npart = [1000, 2000, 3000, 4000, 5000, 6000, 7000, 8000, 9000, 10000]
    L = [2, 3, 4, 5, 6, 7, 8]
    
    for i in range(len(L)):
        avgTotalFreq, uncMeanFreq, avgTotalDamp, uncMeanDamp, avgNoise, uncMeanNoise, totalTime = main(5, 5000, L[i], 100)
